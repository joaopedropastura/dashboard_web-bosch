...
route.get('/profile-aluno/:edv', home.pagProfileAluno)
route.get('/profile-instrutor', home.pagProfileInstrutor)
...
route.post('/dash-board/:edv/:prova', dashBoard.pagDashBoard)
